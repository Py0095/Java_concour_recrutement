...
public class DatabaseApplicant  implements ConcourOperation<Applicant>{
    ...
    @Override
    public HashMap<String, Applicant> viewTheBest() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'viewTheBest'");
    }

    @Override
    public HashMap<String, Applicant> showFiveFirst() {
        // TODO Auto-generated method stub
