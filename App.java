...
public class App {
    ...
    private static void printMenu2(String choix) {
        if (choix.equalsIgnoreCase("Programming")){
            System.out.println("[----------All applicant for the programming domain----------]"); 

        } else if (choix.equalsIgnoreCase("Database")){
            System.out.println("[----------All applicant for the database domain----------]"); 
         } else if (choix.equalsIgnoreCase("Database")){
            System.out.println("[----------All applicant for the Network domain----------]"); 

        }else
            System.out.println("Please enter a valid domain \n\t\t\t[Programing,Database,Network]");
    }
    ...
    private static void printMenu() {
        ...
        System.out.println("[8]. Show all applicants."); // show by specific domain
